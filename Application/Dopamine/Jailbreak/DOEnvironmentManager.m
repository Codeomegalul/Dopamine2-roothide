        ...
        if (hidden != alreadyHidden) {
            if (hidden) {
                if ([self isJailbroken]) {
                    ...
                    // obl1: systemwide domain API absent in libjailbreak — skipped (hide path unused)
                }
                ...
                if ([self isJailbroken]) {
                    // obl1: systemwide domain API absent in libjailbreak — skipped (unhide path unused)
